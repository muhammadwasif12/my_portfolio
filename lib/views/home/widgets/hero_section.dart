...
class _HeroSectionState extends State<HeroSection> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    // LayoutBuilder aur SizedBox hata diye gaye hain
    ...
    return Stack(
      children: [
        // Background ko ab LayoutBuilder chahiye taaki usko size mil sake
        LayoutBuilder(builder: (context, constraints) {
          return _buildEnhancedBackground(constraints.maxWidth, constraints.maxHeight);
        }),
        Center(
          child: Padding(
